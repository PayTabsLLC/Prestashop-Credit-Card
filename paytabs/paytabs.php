...
class Paytabs extends PaymentModule
{
	private $_html = '';
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Paytabs Payment Gateway');
		$this->description = $this->l('Accept payments by Paytabs Gateway.');
	...
	{
		$this->_html .= '<img src="../modules/paytabs/logo.png" style="float:left; margin-right:15px;"><b>'.$this->l('This module allows you to accept payments by Paytabs Payment Gateway.').'</b><br /><br />';
		...
		'<form action="'.Tools::htmlentitiesUTF8($_SERVER['REQUEST_URI']).'" method="post">
			...
			<legend>'.$this->l('Merchant settings').'</legend>
				...
				<table border="0" width="500" cellpadding="0" cellspacing="0" id="form">
					...
					<tr><td width="130" style="height: 35px;">'.$this->l('Merchant Email').'</td><td><input type="text" name="paytabs_id" value="'.htmlentities(Tools::getValue('paytabs_id', $this->paytabs_id), ENT_COMPAT, 'UTF-8').'" style="width: 300px;" /></td></tr>
					<tr><td width="130" style="height: 35px;">'.$this->l('Secret Key').'</td><td><input type="password" name="paytabs_password" value="'.htmlentities(Tools::getValue('paytabs_password', $this->paytabs_password), ENT_COMPAT, 'UTF-8').'" style="width: 300px;" /></td></tr>
